/* ESSA CLASSE E RESPONSAVEL POR RECEBER AS INFORMAÇÕES QUE VEM DO FRONTEND, OU SEJA, TUDO QUE O USUARIO DIGITAR NA TELA DE CADASTRO DE PRODUTOS*/
...
public class ProdutoFormRequest {
	...
	public String toString() {
		return "ProdutoFormRequest [id=" + id + ", descricao=" + descricao + ", nome=" + nome + ", preco=" + preco + ", sku=" + sku
				+ "]";
	}
